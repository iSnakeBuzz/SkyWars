...
public class SSolo implements Database {

    private Main plugin;
    private SnakeAPI snakeAPI;

    public SSolo(Main plugin) {
        this.plugin = plugin;
    ...
    public void createPlayer(UUID playerUUID) {
        ...
        JsonObject playerStats = snakeAPI.GET(RoutePath.SOLO, playerUUID).getAsJsonObject("data");
    ...
    public void savePlayer(Player p) {
        ...
        snakeAPI.POST(RoutePath.SOLO, p.getUniqueId(), statsJson);
