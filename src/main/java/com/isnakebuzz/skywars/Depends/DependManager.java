package com.isnakebuzz.skywars.Depends;

import com.isnakebuzz.skywars.Main;
import com.isnakebuzz.skywars.Utils.Callback;
...
public class DependManager {
    ...
    public void loadDepends() {
        try {
            this.downloadDependency(new URL("http://central.maven.org/maven2/redis/clients/jedis/3.0.1/jedis-3.0.1.jar"), "jedis");
