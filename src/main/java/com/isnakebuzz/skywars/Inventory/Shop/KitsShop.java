...
public class KitsShop extends Menu {

    private Main plugin;

    public KitsShop(Main plugin, String menu_name, Player player) {
    ...
    private void loadKits() {
        ...
        LobbyPlayer skyPlayer = plugin.getPlayerManager().getLbPlayer(this.getPlayer().getUniqueId());
